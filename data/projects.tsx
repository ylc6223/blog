export const projects: Project[] = [
  {
    ...
    preview: '/blog/img/project/blog.png',
  ...
  },
  {
    ...
    preview: '/blog/img/project/nest-vben-admin.png',
    website: '',
    source: '',
  ...
  },
  {
    ...
    preview: '/blog/img/project/big_screen.png',
  ...
  {
    title: 'DailyCheckin',
    description: '🌟 用于地点签到打卡的小程序，摆脱额外安装App的烦恼，并自动向打卡用户发放现金红包。',
    preview: '',
    website: '',
    source: '',
    tags: ['opensource','favorite', 'product','design'],
  ...
  {
    title: 'TodoList',
    description: 'React18实现的TodoList',
    preview: '',
    website: 'https://react-todo-app-rust-sigma.vercel.app',
    source: 'https://github.com/ylc6223/react-todo-app',
    tags: ['opensource','favorite', 'product','design'],
    type: 'toy',
  },
  {
